 ...
 * hits a null character in source before it has copied n characters, the
 * remaining characters are filled with null characters.
 */
 ...
 * string2 alphabetically, negative if string1 comes before string2
...
/**
 * Returns a pointer to the first occurrence of character (converted to a char)
 * in string or a NULL pointer if character cannot be found.
 */
char* new_strchr(const char* string, int character);

/**
 * Returns a pointer to the first occurrence of the string contained in needle
 * in haystack or a NULL pointer if needle cannot be found.
 */
